...
public class RankCommand implements CommandExecutor, TabCompleter {
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		...
		PlayerUtils.updateNametag(args[0]);
		
		if (Bukkit.getPlayer(args[0]) != null && !sender.getName().equalsIgnoreCase(args[0])) {
				
			Bukkit.getPlayer(args[0]).sendMessage(Main.PREFIX + "Your rank was set to '§6" + rank.toString().toLowerCase() + "§7'.");
